...
(id, transactionDate, customerName, phoneNumber, perfumeChoice, perfumeSize, pricePerBottle, quantity, subTotal,
 taxAmount, total)
VALUES (1, '2025-10-01', 'Alice Johnson', '555-1234', 'Dior', '90ml', 40, 2, 80.00, 8.00, 88.00),
       ...
       (6, '2025-10-06', 'Frank Miller', '555-3344', 'Versace', '90ml', 40, 2, 80.00, 8.00, 88.00),
       (7, '2025-10-07', 'Grace Nguyen', '555-7788', 'Burberry', '120ml', 60, 1, 60.00, 6.00, 66.00),
       ...
       (10, '2025-10-10', 'James Wilson', '555-5566', 'Chanel', '90ml', 40, 2, 80.00, 8.00, 88.00)
        ,
       (11, '2025-10-11', 'Katherine Brown', '555-6677', 'YSL', '120ml', 60, 1, 60.00, 6.00, 66.00)
        ,
       (12, '2025-10-12', 'Liam Carter', '555-7789', 'Burberry', '90ml', 40, 5, 200.00, 20.00, 220.00)
        ,
       (13, '2025-10-13', 'Mia Patel', '555-8800', 'Versace', '120ml', 60, 2, 120.00, 12.00, 132.00)
        ,
